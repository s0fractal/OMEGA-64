...
const TARGETS: FileExpectation[] = [
  { file: "02/PULSE.ts", requiresPolicyAccess: "RUNTIME_POLICY.pulse" },
  { file: "07/02/SYSTEM_START.ts", requiresPolicyAccess: "RUNTIME_POLICY.system" },
  {
    file: "04/P2P_FEDERATION.ts",
    requiresPolicyAccess: "RUNTIME_POLICY.federation",
  },
  { file: "04/P2P_SYNAPSE.ts", requiresPolicyAccess: "RUNTIME_POLICY.p2p" },
  { file: "06/AKASHA_SERVER.ts", requiresPolicyAccess: "RUNTIME_POLICY.akasha" },
  {
    file: "06/MUTATION_TELEMETRY.ts",
    requiresPolicyAccess: "RUNTIME_POLICY.telemetry",
  },
  {
    file: "03/CONTROL_INTENT_QUEUE.ts",
    requiresPolicyAccess: "RUNTIME_POLICY.controlIntent",
  },
  {
    file: "05/SOVEREIGN_ORACLE.ts",
...
const main = async () => {
  ...
  const runtimePolicy = await Deno.readTextFile("03/RUNTIME_POLICY.ts");
  if (!runtimePolicy.includes('@00"')) {
    violations.push({
      file: "03/RUNTIME_POLICY.ts",
