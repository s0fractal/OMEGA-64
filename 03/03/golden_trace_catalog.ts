...
const TRACE_ROOT = "03/03/verification/traces";
...
const GOLDEN_TRACE_CATALOG_DATA: GoldenTraceScenario[] = [
  ...
  },
  {
    ...
    supportFiles: [
      "03/03/verification/collective_transport_capture.ts",
      "test_swarm.ts",
    ],
  },
  {
    ...
    supportFiles: [
      "03/03/verification/share_transfer_capture.ts",
      "test_metabolism.ts",
      "test_symbiosis.ts",
    ],
  },
  {
    ...
    supportFiles: [
      "03/03/verification/collective_banking_capture.ts",
      "test_metabolism.ts",
    ],
  },
  {
    ...
    supportFiles: [
      "03/03/verification/collective_synchrony_capture.ts",
      "test_swarm.ts",
      "test_structure_lock_progress.ts",
    ],
  },
  {
    ...
    supportFiles: [
      "03/03/verification/structure_lock_capture.ts",
      "test_structure_lock_progress.ts",
    ],
  },
  {
    ...
    supportFiles: [
      "03/03/verification/structure_charge_capture.ts",
      "test_structure_lock_progress.ts",
    ],
  },
  {
    ...
    supportFiles: [
      "03/03/verification/structure_charge_competition_capture.ts",
      "03/03/verification/structure_charge_capture.ts",
      "test_structure_lock_progress.ts",
    ],
  },
  {
    ...
    supportFiles: [
      "03/03/verification/structure_build_runtime_capture.ts",
      "test_structure_intent_determinism.ts",
    ],
  },
  {
    ...
    supportFiles: [
      "03/03/verification/structure_build_competition_capture.ts",
      "03/03/verification/structure_build_runtime_capture.ts",
      "test_structure_intent_determinism.ts",
    ],
  },
  {
    ...
    supportFiles: [
      "03/03/verification/structure_build_lock_capture.ts",
      "03/03/verification/structure_build_runtime_capture.ts",
      "03/03/verification/structure_lock_capture.ts",
      "test_structure_intent_determinism.ts",
    ],
  },
  {
    ...
    supportFiles: [
      "03/03/verification/tensegrity_capture.ts",
      "test_tensegrity.ts",
    ],
  },
  {
    ...
    supportFiles: [
      "03/03/verification/bind_resolution_capture.ts",
      "test_symbiosis.ts",
    ],
  },
  {
    ...
    supportFiles: [
      "03/03/verification/quorum_sync_capture.ts",
    ],
  },
  {
    ...
    supportFiles: [
      "03/03/verification/intent_resolution_capture.ts",
    ],
  },
  /*
  {
    ...
    supportFiles: [
      "03/03/verification/cognitive_vector_capture.ts",
  ...
  },
  {
    ...
    supportFiles: [
      "03/03/verification/kuramoto_sync_capture.ts",
    ],
  },
  {
    ...
    supportFiles: [
      "03/03/verification/lut_accuracy_capture.ts",
    ],
  },
  {
    ...
    supportFiles: [
      "03/03/verification/resolution_phase_capture.ts",
    ],
  },
  */
];
