const OFFSETS_PATH = "00/OFFSETS.ts";
const STATE_MATRIX_PATH = "00/STATE_MATRIX.ts";
const GLYPH_BUFFER_PATH = "01/GLYPH_BUFFER.ts";
const CONTROL_QUEUE_PATH = "03/CONTROL_INTENT_QUEUE.ts";
const AVATAR_ENGINE_PATH = "05/AVATAR_ENGINE.ts";
const PULSE_PATH = "02/PULSE.ts";
const SYSTEM_START_PATH = "07/02/SYSTEM_START.ts";
const ASSEMBLY_PATH = "00/01/assembly/index.ts";
const ROADMAP_PATH = "63/00/REDUCTION_METABOLISM_ROADMAP.md";
const TRANSITION_PATH = "63/00/OMEGA_TRANSITION_PLAN.md";
