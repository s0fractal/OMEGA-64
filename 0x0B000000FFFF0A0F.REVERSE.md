...
<svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <radialGradient id="grad_0B000000FFFF0A0F" cx="50%" cy="50%" r="50%">
      <stop offset="0%" stop-color="hsl(14, 20%, 15%)" />
      <stop offset="100%" stop-color="#090909" />
    </radialGradient>
    <filter id="glow_0B000000FFFF0A0F" x="-20%" y="-20%" width="140%" height="140%">
      <feGaussianBlur stdDeviation="4" result="blur" />
      <feComposite in="SourceGraphic" in2="blur" operator="over" />
    </filter>
  </defs>
  
  <rect width="200" height="200" fill="url(#grad_0B000000FFFF0A0F)" rx="24"/>
  ...
  <g>
    ...
    <polygon points="100.0,75.0 123.8,92.3 114.7,120.2 85.3,120.2 76.2,92.3" fill="none" stroke="hsl(14, 80%, 60%)" stroke-width="2" filter="url(#glow_0B000000FFFF0A0F)"/>
    
    <circle cx="100" cy="100" r="25" stroke="hsl(14, 60%, 50%)" stroke-width="0.5" fill="none" opacity="0.5"/>
  </g>
  
  <circle cx="100" cy="100" r="3" fill="hsl(194, 80%, 70%)" filter="url(#glow_0B000000FFFF0A0F)"/>
