...
Deno.test("Era 49: Viral Infection & PURGE", async () => {
    ...
    const neutralLogic = new Uint8Array([0x77, 0x88, 0x77, 0x88, 0x77, 0x88, 0x77, 0x88]);
    ...
    assertEquals(Array.from(finalLogic), Array.from(neutralLogic), "PURGE should restore stable logic from memoryGrid");
