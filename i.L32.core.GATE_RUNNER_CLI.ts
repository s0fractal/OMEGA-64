...
import type { ReplayGenesis, ReplayInvariantReport } from "./i.L99.core.REPLAY_AUDIT.ts";
...
const parseArgs = (args: string[]): { input?: string; output?: string; ledger?: string; pretty: boolean; help: boolean } => {
    const out: { input?: string; output?: string; ledger?: string; pretty: boolean; help: boolean } = {
        pretty: false,
        help: false
    };
