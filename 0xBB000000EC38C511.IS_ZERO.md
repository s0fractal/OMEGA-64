...
<svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <radialGradient id="grad_BB000000EC38C511" cx="50%" cy="50%" r="50%">
      <stop offset="0%" stop-color="hsl(277, 20%, 15%)" />
      <stop offset="100%" stop-color="#090909" />
    </radialGradient>
    <filter id="glow_BB000000EC38C511" x="-20%" y="-20%" width="140%" height="140%">
      <feGaussianBlur stdDeviation="4" result="blur" />
      <feComposite in="SourceGraphic" in2="blur" operator="over" />
    </filter>
  </defs>
  
  <rect width="200" height="200" fill="url(#grad_BB000000EC38C511)" rx="24"/>
  ...
  <g>
    ...
    <polygon points="100.0,63.0 128.9,76.9 136.1,108.2 116.1,133.3 83.9,133.3 63.9,108.2 71.1,76.9" fill="none" stroke="hsl(277, 80%, 60%)" stroke-width="2" filter="url(#glow_BB000000EC38C511)"/>
    
    <circle cx="100" cy="100" r="37" stroke="hsl(277, 60%, 50%)" stroke-width="0.5" fill="none" opacity="0.5"/>
  </g>
  
  <circle cx="100" cy="100" r="3" fill="hsl(97, 80%, 70%)" filter="url(#glow_BB000000EC38C511)"/>
  
  <text x="100" y="105" fill="hsl(277, 70%, 80%)" font-family="monospace" font-size="10" text-anchor="middle" letter-spacing="1" opacity="0.9">0xBB00</text>
