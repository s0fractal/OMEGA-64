...
Deno.test("Era 48: Metabolic Balance - SENSE energy cost", async () => {
    ...
    assertAlmostEquals(initialEnergy - finalEnergy, 0.51, 0.01, "SENSE should have a metabolic cost");
...
Deno.test("Era 48: High-Density Friction - Reproduction cost", async () => {
    ...
    assertAlmostEquals(sparseEnergyDelta, 80.01, 0.05, "Sparse reproduction should cost base amount");
    assertAlmostEquals(denseEnergyDelta, 130.01, 1.0, "Dense reproduction should cost significantly more");
