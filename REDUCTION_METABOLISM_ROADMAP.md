...
| Stage 4: shadow verification    | in progress | reduction shadow covers eight bounded `gt01`/`gt03`/`gt04`/`gt05` cases with persisted diff artifacts, and admission shadow now covers `gt04`/`gt06` policy cases separately                                                                                                                                             |
