...
| Stage 2: golden traces          | complete    | capture harness now spans API-observer traces and standalone control specimens; persisted `gt01..gt10` baseline artifacts are committed under `verification/traces/`                                                                                                                                                      |
...
| Stage 4: shadow verification    | in progress | reduction shadow covers fourteen bounded `gt01`/`gt03`/`gt04`/`gt05`/`gt08`/`gt09`/`gt10` cases with persisted diff artifacts, and admission shadow now covers `gt04`/`gt06` policy cases separately                                                                                                                      |
