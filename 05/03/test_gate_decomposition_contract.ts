...
const GATE_PATH = "03/GATE.ts";
const VALIDATOR_PATH = "03/GATE_VALIDATOR.ts";
const MERGER_PATH = "03/GATE_MERGER.ts";
const BUDGET_PATH = "03/GATE_BUDGET.ts";
const LEDGER_PATH = "03/GATE_LEDGER.ts";
