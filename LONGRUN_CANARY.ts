...
const main = async () => {
  ...
  const checks: Check[] = [
    ...
    },
    {
      ...
      limit: enforceSafeModeGate
        ? config.maxSafeModeRatio
        : "n/a(no-daemon-actions)",
  ...
  console.log(`AUDIT [longrun-canary] report: ${REPORT_JSON_PATH}`);
  console.log(`AUDIT [longrun-canary] reportMd: ${REPORT_MD_PATH}`);
