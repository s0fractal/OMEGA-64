...
async function testMetabolism() {
    ...
    console.log(`Test 1 (SHARE): Atom 1 Energy: ${energy1}, Atom 2 Energy: ${energy2}`);
    ...
    console.log(`Test 2 (BANK): Balance: ${bal}, Atom 3 Energy: ${e3}, Atom 4 Energy: ${e4}, Reg 0: ${r0}`);
    if (bal === 1100 && r0 === 100) {
    ...
    console.log(`Test 3 (TROPHIC): Producer Energy: ${e5}, Neutral Energy: ${e6}`);
    if (e5 < 1000 && e6 > 10) {
