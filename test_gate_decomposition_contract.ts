...
const GATE_PATH = "GATE.ts";
const VALIDATOR_PATH = "GATE_VALIDATOR.ts";
const MERGER_PATH = "GATE_MERGER.ts";
const BUDGET_PATH = "GATE_BUDGET.ts";
const LEDGER_PATH = "GATE_LEDGER.ts";
