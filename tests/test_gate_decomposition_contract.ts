...
const GATE_PATH = "03_governance/GATE.ts";
const VALIDATOR_PATH = "03_governance/GATE_VALIDATOR.ts";
const MERGER_PATH = "03_governance/GATE_MERGER.ts";
const BUDGET_PATH = "03_governance/GATE_BUDGET.ts";
const LEDGER_PATH = "03_governance/GATE_LEDGER.ts";
...
const main = async () => {
  ...
  requireSnippet(
    ...
    GATE_PATH,
    "GATE must delegate proposal validation",
    violations,
  );
  requireSnippet(
    gate,
    ...
    GATE_PATH,
    "GATE must delegate proposal merge/budget",
    violations,
  );
  requireSnippet(
    gate,
    ...
    GATE_PATH,
    "GATE must delegate ledger/checkpoint persistence",
    violations,
  );
  forbidSnippet(
    gate,
