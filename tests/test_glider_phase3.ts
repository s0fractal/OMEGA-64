...
import { STATE_SNAPSHOT_StateSnapshot as StateSnapshot, STATE_SNAPSHOT_DeltaProposal as DeltaProposal, STATE_SNAPSHOT_GateConfig as GateConfig, STATE_SNAPSHOT_REJECTION as REJECTION } from "@omega";
