...
const TARGETS: FileExpectation[] = [
  { file: "02_metabolism/PULSE.ts", requiresPolicyAccess: "RUNTIME_POLICY.pulse" },
  { file: "07_meta/02_runners/SYSTEM_START.ts", requiresPolicyAccess: "RUNTIME_POLICY.system" },
  {
    file: "04_noosphere/P2P_FEDERATION.ts",
    requiresPolicyAccess: "RUNTIME_POLICY.federation",
  },
  { file: "04_noosphere/P2P_SYNAPSE.ts", requiresPolicyAccess: "RUNTIME_POLICY.p2p" },
  { file: "06_akasha/AKASHA_SERVER.ts", requiresPolicyAccess: "RUNTIME_POLICY.akasha" },
  {
  ...
  {
    file: "05_exocortex/SOVEREIGN_ORACLE.ts",
