...
async function runTest() {
    ...
    console.log(`📊 A Phase: ${STATE_MATRIX.getPhase(idxA)} | B Resonance: ${STATE_MATRIX.getResonance(idxB)}`);
    ...
    console.log(`📊 B Energy: ${STATE_MATRIX.getEnergy(idxB).toFixed(1)} | C Resonance: ${STATE_MATRIX.getResonance(idxC)}`);
