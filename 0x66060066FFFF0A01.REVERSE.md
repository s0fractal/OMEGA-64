...
<svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <radialGradient id="grad_66060066FFFF0A01" cx="50%" cy="50%" r="50%">
      <stop offset="0%" stop-color="hsl(14, 20%, 15%)" />
      <stop offset="100%" stop-color="#090909" />
    </radialGradient>
    <filter id="glow_66060066FFFF0A01" x="-20%" y="-20%" width="140%" height="140%">
      <feGaussianBlur stdDeviation="4" result="blur" />
      <feComposite in="SourceGraphic" in2="blur" operator="over" />
    </filter>
  </defs>
  
  <rect width="200" height="200" fill="url(#grad_66060066FFFF0A01)" rx="24"/>
  ...
  <g>
    ...
    <polygon points="100.0,75.0 121.7,112.5 78.3,112.5" fill="none" stroke="hsl(14, 80%, 60%)" stroke-width="2" filter="url(#glow_66060066FFFF0A01)"/>
    
    <circle cx="100" cy="100" r="25" stroke="hsl(14, 60%, 50%)" stroke-width="0.5" fill="none" opacity="0.5"/>
  </g>
  
  <circle cx="100" cy="100" r="3" fill="hsl(194, 80%, 70%)" filter="url(#glow_66060066FFFF0A01)"/>
