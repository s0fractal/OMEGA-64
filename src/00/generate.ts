...
const CONSTANTS = {
  ...
  MAX_EGRESS_EVENTS: 8192,
  WASM_PAGE_BYTES: 64 * 1024,
  WASM_MEMORY_PAGES: 7630,
};
...
export const MAX_ATOMS = ${CONSTANTS.MAX_ATOMS};
export const SCALE = ${CONSTANTS.SCALE};
export const GRID_W = ${CONSTANTS.GRID_W};
export const GRID_H = ${CONSTANTS.GRID_H};
...
export const SAFETY_BUFFER = ${CONSTANTS.SAFETY_BUFFER};
...
export const MAX_LEDGER_EVENTS = ${CONSTANTS.MAX_LEDGER_EVENTS};
export const LEDGER_HEAD_OFFSET = SAFETY_BUFFER + 140945912;
export const LEDGER_DATA_OFFSET = SAFETY_BUFFER + 140945916;

export const MAX_EGRESS_EVENTS = ${CONSTANTS.MAX_EGRESS_EVENTS};
...
export const WASM_PAGE_BYTES = ${CONSTANTS.WASM_PAGE_BYTES};
...
export const WASM_MEMORY_PAGES = ${CONSTANTS.WASM_MEMORY_PAGES};
...
pub const MAX_ATOMS: usize = ${CONSTANTS.MAX_ATOMS};

/// Spatial Hash Grid dimensions
pub const GRID_WIDTH: i32 = ${CONSTANTS.GRID_W};
pub const GRID_HEIGHT: i32 = ${CONSTANTS.GRID_H};
pub const GRID_SIZE: usize = (GRID_WIDTH * GRID_HEIGHT) as usize;
pub const CELL_CAPACITY: usize = ${CONSTANTS.CELL_CAPACITY};

/// Maximum boundaries for execution scopes
pub const MAX_PC: u8 = ${CONSTANTS.MAX_PC};
pub const MAX_EXECUTION_STEPS: usize = ${CONSTANTS.MAX_EXECUTION_STEPS};
pub const ATOM_LOGIC_SIZE: usize = ${CONSTANTS.ATOM_LOGIC_SIZE};

/// Energy representation scaling factor (Fractional to Integer boundary mapping via Deno)
pub const ENERGY_SCALE: i32 = ${CONSTANTS.SCALE};
...
console.log("[DAG] Successfully generated Isomorphic Topology (`OFFSETS.ts` & `constants.rs`)");
