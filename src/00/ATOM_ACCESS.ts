...
import {
  ...
  PROP_QUORUM, PROP_NEURAL_COHERENCE, PROP_MEMORY,
  SYS_YIELD, SYS_READ_MEM, SYS_WRITE_MEM, SYS_SPAWN, SYS_BIND, SYS_SET_ROLE,
  SYS_MUTATE, SYS_MSG, SYS_READ_INBOX, SYS_TRANSFER, SYS_REPLICATE, SYS_EMIT,
  SYS_SCAN, SYS_MOVE, SYS_EAT, SYS_BET, SYS_ATTRACT, SYS_FOLD, SYS_SPORE_DRIVE as SYS_SPORE_DRIVE_CONST, SYS_SENSE_PHASE,
  STR_VOID, STR_WIRE, STR_NODE, STR_DIODE, STR_SOURCE, STR_SINK, STR_CAPACITOR, STR_INVERTER, STR_LATCH,
} from "../_/00/mod.ts";
...
export const RISC = {
  ...
  OP_PLUG,
  OP_TENSEGRITY,
  OP_ENTANGLE: OP_HEBB, // legacy map for coherence
  OP_BUILD,
  OP_SENSE,
  OP_COLLECTIVE,
  OP_ROLE: OP_SECRETE_PLASMID, // legacy map for compatibility
  OP_SPORE_DRIVE,
  OP_SENSE_AS, // replaced OP_WISDOM
  OP_RESOLVE,
...
export const SYS = {
  YIELD: SYS_YIELD,
  READ_MEM: SYS_READ_MEM,
  WRITE_MEM: SYS_WRITE_MEM,
  SPAWN: SYS_SPAWN,
  BIND: SYS_BIND,
  SET_ROLE: SYS_SET_ROLE,
  MUTATE: SYS_MUTATE,
  MSG: SYS_MSG,
  READ_INBOX: SYS_READ_INBOX,
  TRANSFER: SYS_TRANSFER,
  REPLICATE: SYS_REPLICATE,
  EMIT: SYS_EMIT,
  SCAN: SYS_SCAN,
  ATTRACT: SYS_ATTRACT,
  FOLD: SYS_FOLD,
