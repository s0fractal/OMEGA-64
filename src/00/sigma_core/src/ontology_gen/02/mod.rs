...
#[path = "semanticBonusesBuffer.rs"]
pub mod semanticBonusesBuffer;
pub use semanticBonusesBuffer::*;
#[path = "set_reg.rs"]
pub mod set_reg;
pub use set_reg::*;
#[path = "get_role.rs"]
...
pub mod get_phase;
pub use get_phase::*;
#[path = "memory_views_base.rs"]
pub mod memory_views_base;
pub use memory_views_base::*;
