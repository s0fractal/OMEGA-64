import { OP_NOP, OP_SET, OP_GET, OP_PUT, OP_ADD, OP_SUB, OP_JZ, OP_JNZ, OP_JMP, OP_REPLICATE, OP_SIGNAL, OP_BIND, OP_SHARE, OP_PLUG, OP_TENSEGRITY, OP_HEBB, OP_BUILD, OP_SENSE, OP_COLLECTIVE, OP_SECRETE_PLASMID, OP_SPORE_DRIVE, OP_SENSE_AS, OP_RESOLVE, OP_RESONATE_KURAMOTO, OP_SYSCALL } from "@generated";
