...
<svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <radialGradient id="grad_60000000CD9F3C7E" cx="50%" cy="50%" r="50%">
      <stop offset="0%" stop-color="hsl(85, 20%, 15%)" />
      <stop offset="100%" stop-color="#090909" />
    </radialGradient>
    <filter id="glow_60000000CD9F3C7E" x="-20%" y="-20%" width="140%" height="140%">
      <feGaussianBlur stdDeviation="4" result="blur" />
      <feComposite in="SourceGraphic" in2="blur" operator="over" />
    </filter>
  </defs>
  
  <rect width="200" height="200" fill="url(#grad_60000000CD9F3C7E)" rx="24"/>
  ...
  <g>
    ...
    <polygon points="100.0,71.0 125.1,114.5 74.9,114.5" fill="none" stroke="hsl(85, 80%, 60%)" stroke-width="2" filter="url(#glow_60000000CD9F3C7E)"/>
    
    <circle cx="100" cy="100" r="29" stroke="hsl(85, 60%, 50%)" stroke-width="0.5" fill="none" opacity="0.5"/>
  </g>
  
  <circle cx="100" cy="100" r="3" fill="hsl(265, 80%, 70%)" filter="url(#glow_60000000CD9F3C7E)"/>
  
  <text x="100" y="105" fill="hsl(85, 70%, 80%)" font-family="monospace" font-size="10" text-anchor="middle" letter-spacing="1" opacity="0.9">0x6000</text>
