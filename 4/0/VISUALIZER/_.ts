...
const WAVE_SIGNAL = WAVE_SIGNAL_ATOM({ siblings: { I } });
const INTERFERENCE = INTERFERENCE_ATOM({ siblings: { WAVE_SIGNAL } });
const ARENA = ARENA_ATOM({
  siblings: {
    FIELD,
    WAVE_PACKET: WAVE_PACKET_ATOM_RESULT,
    INTERFERENCE,
    I16_LIMITS
  }
});
