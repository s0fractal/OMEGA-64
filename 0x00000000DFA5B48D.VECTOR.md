...
<svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <radialGradient id="grad_00000000DFA5B48D" cx="50%" cy="50%" r="50%">
      <stop offset="0%" stop-color="hsl(253, 20%, 15%)" />
      <stop offset="100%" stop-color="#090909" />
    </radialGradient>
    <filter id="glow_00000000DFA5B48D" x="-20%" y="-20%" width="140%" height="140%">
      <feGaussianBlur stdDeviation="4" result="blur" />
      <feComposite in="SourceGraphic" in2="blur" operator="over" />
    </filter>
  </defs>
  
  <rect width="200" height="200" fill="url(#grad_00000000DFA5B48D)" rx="24"/>
  ...
  <g>
    ...
    <polygon points="100.0,82.0 115.6,109.0 84.4,109.0" fill="none" stroke="hsl(253, 80%, 60%)" stroke-width="2" filter="url(#glow_00000000DFA5B48D)"/>
    
    <circle cx="100" cy="100" r="18" stroke="hsl(253, 60%, 50%)" stroke-width="0.5" fill="none" opacity="0.5"/>
  </g>
  
  <circle cx="100" cy="100" r="3" fill="hsl(73, 80%, 70%)" filter="url(#glow_00000000DFA5B48D)"/>
  
  <text x="100" y="105" fill="hsl(253, 70%, 80%)" font-family="monospace" font-size="10" text-anchor="middle" letter-spacing="1" opacity="0.9">0x0000</text>
