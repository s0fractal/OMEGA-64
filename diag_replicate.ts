...
STATE_MATRIX.setEnergy(0, 3000); STATE_MATRIX.setResonance(0, 400);
...
console.log('BEFORE: spawn head=', new Int32Array(STATE_MATRIX.buffer, SPAWN_BASE, 1)[0]);
await PULSE.tick();
console.log('AFTER: opcode=0x' + STATE_MATRIX.getLogic(0)[0].toString(16));
console.log('AFTER: spawn head=', new Int32Array(STATE_MATRIX.buffer, SPAWN_BASE, 1)[0]);
