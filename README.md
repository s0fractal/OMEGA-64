...
- `deno task ci:soak:worker4` (local mirror of nightly 4-worker long burn-in + resilience trend gate)
...
- GitHub Actions nightly soak: `.github/workflows/coherence-nightly-soak.yml` (scheduled long-run 4-worker sentinel + resilience audit/budget/trend artifacts)
